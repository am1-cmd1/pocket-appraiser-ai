  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-6 text-slate-100">
      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 p-8 rounded-3xl">
        <h2 className="text-2xl font-black uppercase italic mb-6">Dealer Login</h2>
        ...
        <p className="mt-6 text-center text-slate-500 text-sm">
            Don't have an account? <Link href="/signup" className="text-yellow-500 font-bold hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
  );
